...
for jj=1:length(nums)
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(1).scans = {
                                                        ...
                                                        '/ZPOOL/data/projects/stim-dcm/derivatives/fmriprep/sub-'+nums(jj)+'/func/sub-'+nums(jj)+'_task-cardgame_run-1_vol0'+nums(jj)+'.nii,1'
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(2).scans = {
                                                        ...
                                                        '/ZPOOL/data/projects/stim-dcm/derivatives/fmriprep/sub-'+nums(jj)+'/func/sub-'+nums(jj)+'_task-cardgame_run-2_vol0'+nums(jj)+'.nii,1'
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(3).scans = {
                                                        ...
                                                        '/ZPOOL/data/projects/stim-dcm/derivatives/fmriprep/sub-'+nums(jj)+'/func/sub-'+nums(jj)+'_task-cardgame_run-3_vol0'+nums(jj)+'.nii,1'
    ...
    %% code for contrasts
    matlabbatch{1}.spm.stats.con.spmmat = {'/ZPOOL/data/projects/stim-dcm/derivatives/spm/sub-189/1stlevel_withConfounds/SPM.mat'};
    matlabbatch{1}.spm.stats.con.consess{1}.tcon.name = 'R_vlpfc';
    matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = [0 0 0 1];
    ...
    matlabbatch{1}.spm.stats.con.consess{4}.tcon.weights = [1 0 0 0];
    ...
    matlabbatch{1}.spm.stats.con.consess{7}.tcon.weights = [0 -1 0 1];
